                ...
                <li class="dropdown user user-menu">
                    ...
                    <?php  if(isset(Yii::$app->user->identity->profile->image)){ 
                        ...
                        <img src="data:image/jpeg;base64,<?php echo 
                                             (!empty(Yii::$app->user->identity->profile->cropped_image))? Yii::$app->user->identity->profile->cropped_image : Yii::$app->user->identity->profile->image ; ?>" class="user-image" alt="User Image"/>
                    <?php } ?>
